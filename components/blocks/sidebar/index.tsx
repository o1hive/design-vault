...
import { Avatar, AvatarFallback } from "@/components/shadcn-components/avatar"
              ...
              <div className=" mt-[1.5px] flex w-full">
                <DropdownMenu modal={false}>
                  ...
                  <DropdownMenuContent align="start">
                    <DropdownMenuItem className="flex items-center gap-2" render={<a href="/settings/members" />}><UserCog className="h-4 w-4" />Manage members
                                                            </DropdownMenuItem>{" "}
                    <DropdownMenuItem className="flex items-center gap-2" render={<a href="/settings/integrations" />}><Blocks className="h-4 w-4" />Integrations
                                                            </DropdownMenuItem>
                    <DropdownMenuItem render={<a href="/select-org" className="flex items-center gap-2" />}><Plus className="h-4 w-4" />Create or join an organization
                                                            </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              </div>
                ...
                <div>
                  <DropdownMenu modal={false}>
                    ...
                    <DropdownMenuContent sideOffset={5}>
                      ...
                      <DropdownMenuSeparator />
                      <DropdownMenuItem className="flex items-center gap-2" render={<a href="/settings/profile" />}><UserCircle className="h-4 w-4" />Profile
                                                                  </DropdownMenuItem>
                      <DropdownMenuItem
