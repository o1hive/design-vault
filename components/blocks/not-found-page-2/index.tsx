      ...
      <Empty>
        ...
        <EmptyContent>
          <div className="flex gap-2">
            <Button render={<a href="#" />} nativeButton={false}><Home className="mr-2 h-4 w-4" />Go Home
                                    </Button>

            <Button variant="outline" render={<a href="#" />} nativeButton={false}><Compass className="mr-2 h-4 w-4" />Explore
                                    </Button>
          </div>
        </EmptyContent>
      </Empty>
