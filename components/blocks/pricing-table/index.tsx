...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/shadcn-components/select"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 max-w-4xl mx-auto">
          {tiers.map((tier, index) => (
            <Card
              key={index}
              className={cn("bg-card border-border p-6 flex flex-col", tier.isPrimary && "ring-2 ring-primary")}
            >
              {/* Tier Header */}
              <div className="mb-6">
