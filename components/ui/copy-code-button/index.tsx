...
export function CopyCode({ code = "o1hive", duration = 2000, copiedText = "Code Copied!" }: CopyCodeProps) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-background p-4">
      <div className="relative overflow-hidden flex items-center justify-center bg-muted rounded-full px-10 py-3 min-w-80 h-16">
        {/* Progress background */}
        <div
        ...
        >
          ...
          <button
            onClick={handleCopy}
            className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium text-lg px-8 py-3 rounded-full shadow-sm transition-all duration-300 hover:shadow-md active:scale-95 cursor-pointer select-none"
          >
            Copy
          </button>
        </div>
